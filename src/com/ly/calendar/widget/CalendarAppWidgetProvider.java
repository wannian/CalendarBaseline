...
package com.ly.calendar.widget;
...
import com.ly.calendar.AllInOneActivity;
import com.ly.calendar.EventInfoActivity;
...
public class CalendarAppWidgetProvider extends AppWidgetProvider {
    ...
    static final String EXTRA_EVENT_IDS = "com.ly.calendar.EXTRA_EVENT_IDS";
    ...
    private void performUpdate(Context context,
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            launchCalendarIntent
                    .setData(Uri.parse("content://com.ly.calendar/time/" + millis));
    ...
    static Intent getLaunchFillInIntent(Context context, long id, long start, long end,
        ...
        String dataString = "content://com.ly.calendar/events";
        if (id != 0) {
