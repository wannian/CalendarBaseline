...
import com.ly.calendar.CalendarUtils.TimeZoneUtils;
 ...
 * "adb shell am instrument -w -e class com.ly.calendar.UtilsTests
 *          com.ly.calendar.tests/android.test.InstrumentationTestRunner"
 */
...
*/
    ...
    public void testGetDisplayedDatetime_differentYear() {
        ...
        result = Utils.getDisplayedDatetime(start, end, NOW_TIME, DEFAULT_TIMEZONE,
                false, dbUtils.getContext());
        assertEquals("Mon, Dec 31, 2012, 5:00pm 鈥�Tue, Jan 1, 2013, 6:00pm", result);
    }
